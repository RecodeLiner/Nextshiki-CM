...
data class PeopleObject (
    ...
    @SerialName("groupped_roles") val grouppedRoles: List<String> = arrayListOf(),
    @SerialName("roles") val roles: List<Roles> = arrayListOf(),
    @SerialName("works") val works: List<Works> = arrayListOf(),
